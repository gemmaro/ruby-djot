...
module Djot
  class LuaTest < Test::Unit::TestCase
    test "render HTML" do
      assert_equal("<p>This is <strong>djot</strong></p>\n", Djot::Lua.render_html("This is *djot*"))
    end

    test "render matches" do
      assert_equal(<<~END_MATCHES.encode(Encoding::ASCII_8BIT), Djot::Lua.render_matches("This is *djot*"))
        +para 1-1
        str 1-8
        +strong 9-9
        str 10-13
    ...
    test "render AST" do
      assert_equal(<<~END_MATCHES.encode(Encoding::ASCII_8BIT), Djot::Lua.render_ast("This is *djot*"))
        para
          str
            "This is "
          strong
      ...
      File.foreach(path) do |line|
        ...
        when States::OUTPUT
          ...
          test "#{File.basename(path)} > #{index}" do
            assert_equal(current_case.output, Djot::Lua.render_html(current_case.input))
          end
          current_case.input = ""
          current_case.output = ""
